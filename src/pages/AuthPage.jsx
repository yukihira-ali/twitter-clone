...
export default function AuthPage() {
    ...
    const url = "https://e19db358-75a4-473f-9aa4-bca3b185ded6-00-2st3kbjtv1e1v.pike.replit.dev";
    ...
    return (
        <Row>
            ...
            <Col sm={6} className="p-4">
                ...
                <p className='mt-5' style={{ fonstSize: 64 }}>Happening Now</p>
                <h2 className='mt-5' style={{ fonstSize: 31 }}>Join Twitter Now</h2>
